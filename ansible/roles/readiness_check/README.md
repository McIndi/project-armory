...
Intended to be run after `beeai_agentstack_tofu` completes to verify all services are ready for use.
...
ansible-playbook playbooks/site.yml -e 'readiness_check_beeai_enabled=true readiness_check_k3s_enabled=true' --tags readiness_check
```
