...
template {
  contents = <<EOT
{{- with pkiCert "${pki_int_mount}/issue/${pki_int_role}" "common_name=wazuh-indexer.armory.internal" "ttl=${cert_ttl}" "alt_names=wazuh-indexer.armory.internal,wazuh-indexer,${indexer_container_name}" "ip_sans=127.0.0.1" -}}
{{ .Cert }}{{ .CA }}
{{ .Key }}
{{- end }}
EOT
